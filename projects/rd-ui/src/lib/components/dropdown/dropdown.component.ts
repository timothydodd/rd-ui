...
@Component({
  ...
  template: `
    <div class="rd-dropdown-container" [class.disabled]="disabled()" [class.multiple]="multiple()" [class.rd-dropdown-sm]="size() === 'sm'" [class.compact]="size() === 'compact'" [class.rd-dropdown-lg]="size() === 'lg'">
      <div
      ...
      @if (isOpen()) {
        <div class="rd-dropdown-panel" [style.min-width.px]="minWidth()">
          @if (searchable()) {
          ...
          @if (multiple() && showSelectAll() && filteredOptions().length > 0) {
            <div class="rd-dropdown-select-all">
              <div
                class="rd-dropdown-item select-all-item"
          ...
          <div class="rd-dropdown-items custom-scrollbar">
            @if (triState()) {
